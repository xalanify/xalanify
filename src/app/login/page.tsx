...
export default function LoginPage() {
  ...
  const handleAuth = async (e: React.FormEvent) => {
    ...
    // O Contexto vai detetar a mudança de auth automaticamente, não precisas de reload.
  };

  return (
    <div className="min-h-screen w-full bg-[#050a18] flex items-center justify-center p-6 relative overflow-hidden font-sans">
