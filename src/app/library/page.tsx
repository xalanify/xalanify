...
export default function LibraryPage() {
  const { 
    playlists, likedTracks, createPlaylist, themeColor, 
    setCurrentTrack, setIsPlaying, currentTrack, setActiveQueue 
  } = useXalanify();
    ...
    <div className="p-8 pb-40 animate-app-entry">
      ...
      <div className="space-y-4">
        <div onClick={() => setView({ type: 'liked' })} className="glass p-8 rounded-[3rem] flex items-center gap-6 hover:bg-white/5 cursor-pointer border-white/5">
          ...
          <div>
            <p className="font-black text-2xl tracking-tight">Gostadas</p>
