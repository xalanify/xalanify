-- =====================================================================
-- Just fix the function - tables already exist
-- Run this in Supabase SQL Editor
-- =====================================================================

-- Create a new function with a different name to avoid conflict
...
SELECT 'Function import_playlist_by_id_v2 created successfully!' as result;
