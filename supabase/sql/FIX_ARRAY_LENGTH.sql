-- Fix for array_length error in import_playlist_by_id function
-- Use jsonb_array_length instead of array_length for jsonb data
...
BEGIN
  ...
  -- Use jsonb_array_length instead of array_length for jsonb
  SELECT COALESCE(jsonb_array_length(v_playlist.tracks_json), 0) INTO v_track_count;
